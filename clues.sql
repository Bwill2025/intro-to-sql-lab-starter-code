...
SELECT language FROM countrylanguages WHERE countrycode = 'VAT'; language

-- Clue #3: We have new news on the classes Carmen attended – our gumshoes tell us she's moved on to a different country, a country where people speak only the language she was learning. Find out which nearby country speaks nothing but that language.

-- Write SQL query here

SELECT countrycode FROM countrylanguages WHERE language = 'Italian' AND percentage = '100'; countrycode
SELECT name FROM countries WHERE code = 'SMR'; name
...
WHERE cities.name 
LIKE 'Ser%' AND countries.continent = 'South America';
    name
